...
export default function NavbarLogo({ themeColor }){
    ...
    if(themeColor == 'dark' || themeColor == 'accent'){
        ...
        return (<>
                <img src={ al3_logo_dark } className="h-9 white:hidden dark:block accent:block" alt="AL3 Logo1" />
        ...
        return (<>
                <img src={ al3_logo } className="h-9 white:block dark:hidden accent:hidden" alt="AL3 Logo3" />
                <img src={ al3_logo_txt } className="w-15 h-5 white:block dark:hidden accent:hidden ml-3" alt="AL3 Logo4" />
            </>)
    }
}