                    ...
                    <tbody>
                        <tr className="flex item-center justify-start flex-col lg:flex-row w-full">
                            ...
                            <td className="px-6 py-4 w-full">
                                <p className="white:text-gray-500 graytheme:text-gray-300 accent:text-gray-300">Born in Trece Martirez, Cavite</p>
                            </td>
                        </tr>
                        <tr className="flex item-center justify-start flex-col lg:flex-row w-full">
                        ...
                        <tr className="flex item-center justify-start flex-col lg:flex-row w-full">
                            ...
                            <td className="px-6 py-4 w-full">
                                <p className="white:text-gray-500 graytheme:text-gray-300 accent:text-gray-300">Worked @ON Semiconductor Philippines Incorporated (OSPI)<br/>
                                (Web Developer)
                                </p>
                            </td>
                        </tr>
                        <tr className="flex item-center justify-start flex-col lg:flex-row w-full">
                            ...
                            <td className="px-6 py-4 w-full">
                                <p className="white:text-gray-500 graytheme:text-gray-300 accent:text-gray-300">Worked @Tsukiden Electric Industries Philippines Incorporated (TEIPI)<br/>
                        ...
                        <tr className="flex item-center justify-start flex-col lg:flex-row w-full">
                            ...
                            <td className="px-6 py-4 w-full">
                                <p className="white:text-gray-500 graytheme:text-gray-300 accent:text-gray-300">Currently working @URATEX Philippines (MULTIFLEX RNC)<br/>
